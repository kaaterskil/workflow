...
public class ImplicitThrowEvent extends ThrowEvent {
    ...
    public String toString() {
        return String.format(
                "ImplicitThrowEvent [eventDefinitionRefs=%s, eventDefinitions=%s, dataInputAssociations=%s, dataInputs=%s, inputSet=%s, properties=%s, incoming=%s, outgoing=%s, name=%s, categoryValueRef=%s, id=%s, documentation=%s, extensionElements=%s]",
