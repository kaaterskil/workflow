...
public interface EventSubscriptionService {
    ...
    List<CompensationEventSubscription> findCompensationEventSubscriptionsByToken(Token token);
    ...
    CompensationEventSubscription createCompensationEventSubscription();

    CompensationEventSubscription insertCompensationEvent(Token token, String activityId);
